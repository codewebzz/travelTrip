 <?php
    session_start();
    require_once '../include/db.php'; // Make sure this points to your DB config
 ...
 <body>
         ...
         (function() {
             function c() {
                 ...
                 if (b) {
                     ...
                     d.innerHTML = "window.__CF$cv$params={r:'8ca8d7680fb211ac',t:'MTcyNzU4MDA2OS4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='../../../cdn-cgi/challenge-platform/h/g/scripts/jsd/ec4b873d446c/maind41d.js';document.getElementsByTagName('head')[0].appendChild(a);";
     ...
     <script defer
         ...
         data-cf-beacon='{"rayId":"8ca8d7680fb211ac","version":"2024.8.0","r":1,"serverTiming":{"name":{"cfExtPri":true,"cfL4":true}},"token":"2aaac9563824454ba89abdea91540009","b":1}'
